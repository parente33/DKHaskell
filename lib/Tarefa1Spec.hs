...
p7 = Personagem (0,0) Jogador (2,2) Este (0.5,0.5) False False 10 0 (False, 0.0)

p8 = Personagem (0,0) Fantasma (3,2) Este (0.8,0.8) True False 2 0 (False, 0.0)

teste4 = "T4: Personagens colidem " ~: False ~=? colisoesPersonagens p7 p8

p9 = Personagem (0,0) Jogador (9.5,1.5) Este (1,1) False False 10 0 (False, 0.0)

p10 = Personagem (0,0) Fantasma (10,1.5) Oeste (1,1) True False 2 0 (False, 0.0)

teste5 = "T5: Personagens colidem " ~: True ~=? colisoesPersonagens p9 p10
...
teste6 = "T6: Jogador nao colide com nenhuma parede " ~: False ~=? colisoesParede gameMap1 pl1

pl2 = Personagem (0.0,0.0) Jogador (0.2,6.5) Este (1,1) False False 10 0 (False, 0.0)

teste7 = "T7: Jogador colide com limite lateral " ~: True ~=? colisoesParede gameMap1 pl2

pl3 = Personagem (0.0,0.0) Jogador (8.5,0.2) Este (1,1) False False 10 0 (False, 0.0)

teste8 = "T8: Jogador colide com limite superior " ~: True ~=? colisoesParede gameMap1 pl3

pl4 = Personagem (0.0,0.0) Jogador (7.5,2.5) Este (2,2) False False 10 0 (False, 0.0)

teste9 = "T9: Jogador colide com plataforma " ~: True ~=? colisoesParede gameMap1 pl4

testesTarefa1 = test [teste1, teste2, teste3, teste4, teste5, teste6, teste7, teste8, teste9]
